...
public class SubInformation implements Comparable{
    ...
    private HashSet<String> supportingMethods;
    ...
    public HashSet<String> getSupportingMethods() {
    ...
    public int compareTo(@NotNull Object o) {
        ...
        if (this.getPosition() == that.getPosition()) {
            that.supportingMethods.addAll(this.getSupportingMethods());
            that.identicalAlt = that.alt.equals(this.getAlt());
            that.totalIndiv = Integer.min(that.totalIndiv, this.getTotalIndiv());
            return 0;
