...
public class VennHandler {
    ...
    private String chr;
    private Set<SubInformation> variants = new TreeSet<>();


    public VennHandler() {
    }

    public void compFiles(HashMap<String, List<SubInformation>> methods) throws IOException {
        ...
        variants.forEach(e -> {
            try {
                bw.write(chr + "\t");
                bw.write(Long.toString(e.getPosition()) + "\t");
                bw.write(Long.toString(e.getTotalIndiv()) + "\t");
    ...
    public HashMap<String, List<SubInformation>> getAllConcordantVars() {
