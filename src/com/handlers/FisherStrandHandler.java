...
public class FisherStrandHandler {
    ...
    public List<Double> countReads(int offset) {
        //LinkedHashMap<String, LinkedHashMap<String, ArrayList<Integer>>> hashCount = new LinkedHashMap<>();
    ...
    private int countOccurrences(Pattern pattern, String sequence) {
        ...
        List occurrences = set.stream().map(e -> list.stream().filter(el -> el.equals(e)).count()).collect(Collectors.toList());
