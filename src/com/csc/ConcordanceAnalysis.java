...
class ConcordanceAnalysis {
    ...
    private HashMap<String, GenotypeStatus> hashQTLstatus = new HashMap<>();
    private HashMap<Integer, String> hashAniPosInVCF = new HashMap<>();
    private HashMap<String, HashMap<String, HashMap<String, GenotypeStatus>>> hashGenotype = new HashMap<>();
    private HashMap<String, HashMap<String, AllelicInfo>> alleleFrequency = new HashMap<>();

    private ArrayList<String> allAllele = new ArrayList<>();
    ...
    private void checkNames() throws IOException {
        ...
        List<String> qtlIndiv = new ArrayList<>(10);
        //Logger.getLogger("LOG").log(Level.INFO, "Checking homozygosity from VCF file");
        ...
        if (vcfIndiv.size() != qtlIndiv.size()) {
            System.out.println("Number of individuals from VCF file doesn't match the QTL status file !");
            System.exit(0);
        }
...
//TODO needs optimisation
    ...
    private void checkGenotype() throws IOException {
        ...
        BufferedReader vcf = new BufferedReader(new FileReader(ArgsHandler.INSTANCE.getVcfPath()));
        String line;
        String chr;
        String pos;
        String alt;
        String ref;
        int gqIndex = -1;
        System.out.println("Checking homozygosity from VCF file");
    ...
    private void compareStatus() throws IOException {
        System.out.println("Comparing genotype and QTL status");
        // add extension
    ...
    void run() {
        ...
        if (ArgsHandler.INSTANCE.getBamFiles() != null && ArgsHandler.INSTANCE.getRef() != null) {
            ...
            System.out.println("BAM files or reference file not provided! Skipping fisher strand computation.");
        }
